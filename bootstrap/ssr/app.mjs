...
const getters = {
  ...
  getTotalItem(state2) {
    var _a2, _b;
    if (((_a2 = state2.cart) == null ? void 0 : _a2.length) > 99) {
      return "99+";
    } else {
      return (_b = state2.cart) == null ? void 0 : _b.length;
    }
  },
  getTotalPrice(state2) {
    let total = 0;
    state2.cart.forEach((item) => {
      if (item.saleprice > "0") {
  ...
  getTotalDiscount(state2) {
    return state2.totalDiscount;
  },
  getGrandTotal(state2, getters2) {
    return getters2.getTotalPrice - state2.totalDiscount;
  }
};
const actions = {
...
const mutations = {
  ADD_TO_CART(state2, item) {
    let selectedItem = state2.cart.find((book) => book.id == item.id);
    if (selectedItem) {
  ...
  SAVE_DATA(state2) {
    localStorage.setItem("cart", JSON.stringify(state2.cart));
  },
  SET_CART(state2) {
    state2.cart = localStorage.getItem("cart") ? JSON.parse(localStorage.getItem("cart")) : [];
  },
  CART_ITEM_QUANTITY(state2, payload) {
    console.log(payload.val.data);
    let selectedItem = state2.cart.find((book) => book.id == payload.item.id);
  ...
  REMOVE_FROM_CART(state2, item) {
    let index = state2.cart.indexOf(item);
    state2.cart.splice(index, 1);
  },
  RESET_CART(state2) {
...
createInertiaApp({
  ...
  resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./Pages/API/Index.vue": () => import("./assets/Index.43e14129.mjs"), "./Pages/API/Partials/ApiTokenManager.vue": () => import("./assets/ApiTokenManager.9bf937f9.mjs"), "./Pages/Admin/AdminPayments.vue": () => import("./assets/AdminPayments.c321f91b.mjs"), "./Pages/Admin/Affiliates/Index.vue": () => import("./assets/Index.306c7f79.mjs"), "./Pages/Admin/Affiliates/Show.vue": () => import("./assets/Show.54ecdbb0.mjs"), "./Pages/Admin/Auth/Login.vue": () => import("./assets/Login.32d4e061.mjs"), "./Pages/Admin/Auth/Register.vue": () => import("./assets/Register.149f0829.mjs"), "./Pages/Admin/Customers/Index.vue": () => import("./assets/Index.fdcb07eb.mjs"), "./Pages/Admin/Customers/Show.vue": () => import("./assets/Show.fde8e620.mjs"), "./Pages/Admin/Dashboard.vue": () => import("./assets/Dashboard.252f64c2.mjs"), "./Pages/Admin/Orders/Convert.vue": () => import("./assets/Convert.7dbd4d17.mjs"), "./Pages/Admin/Orders/Index.vue": () => import("./assets/Index.bd38fae3.mjs"), "./Pages/Admin/Products/Create.vue": () => import("./assets/Create.b0594be3.mjs"), "./Pages/Admin/Products/Edit.vue": () => import("./assets/Edit.32ddef6f.mjs"), "./Pages/Admin/Products/Index.vue": () => import("./assets/Index.dcd84e68.mjs"), "./Pages/Admin/Profile/Partials/DeleteUserForm.vue": () => import("./assets/DeleteUserForm.f28556f0.mjs"), "./Pages/Admin/Profile/Partials/LogoutOtherBrowserSessionsForm.vue": () => import("./assets/LogoutOtherBrowserSessionsForm.8e8b67a9.mjs"), "./Pages/Admin/Profile/Partials/TwoFactorAuthenticationForm.vue": () => import("./assets/TwoFactorAuthenticationForm.9d0d246f.mjs"), "./Pages/Admin/Profile/Partials/UpdatePasswordForm.vue": () => import("./assets/UpdatePasswordForm.9285979f.mjs"), "./Pages/Admin/Profile/Partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm.2e286004.mjs"), "./Pages/Admin/Profile/Show.vue": () => import("./assets/Show.1a35d238.mjs"), "./Pages/Affiliates/Dashboard.vue": () => import("./assets/Dashboard.3e1547af.mjs"), "./Pages/Affiliates/Login.vue": () => import("./assets/Login.be150b92.mjs"), "./Pages/Affiliates/Register.vue": () => import("./assets/Register.37a87e72.mjs"), "./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword.1168762b.mjs"), "./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword.25eb6734.mjs"), "./Pages/Auth/Login.vue": () => import("./assets/Login.1f59dcfc.mjs"), "./Pages/Auth/Register.vue": () => import("./assets/Register.61f70c63.mjs"), "./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword.d0b84076.mjs"), "./Pages/Auth/TwoFactorChallenge.vue": () => import("./assets/TwoFactorChallenge.27be4586.mjs"), "./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail.da244e53.mjs"), "./Pages/Business/Auth/Login.vue": () => import("./assets/Login.e654886a.mjs"), "./Pages/Business/Auth/Register.vue": () => import("./assets/Register.70653cb3.mjs"), "./Pages/Business/Dashboard.vue": () => import("./assets/Dashboard.7f589630.mjs"), "./Pages/Business/Generate-Quotation.vue": () => import("./assets/Generate-Quotation.338751ca.mjs"), "./Pages/Business/Orders.vue": () => import("./assets/Orders.3a10264d.mjs"), "./Pages/Cart.vue": () => import("./assets/Cart.4e658dfd.mjs"), "./Pages/Checkout.vue": () => import("./assets/Checkout.69f7e6ad.mjs"), "./Pages/Dashboard.vue": () => import("./assets/Dashboard.0e40042c.mjs"), "./Pages/Home.vue": () => import("./assets/Home.76f0fcf6.mjs"), "./Pages/Orders.vue": () => import("./assets/Orders.5e05ec42.mjs"), "./Pages/PrivacyPolicy.vue": () => import("./assets/PrivacyPolicy.65185f9e.mjs"), "./Pages/Profile/Partials/DeleteUserForm.vue": () => import("./assets/DeleteUserForm.0edf95dd.mjs"), "./Pages/Profile/Partials/LogoutOtherBrowserSessionsForm.vue": () => import("./assets/LogoutOtherBrowserSessionsForm.17af4c27.mjs"), "./Pages/Profile/Partials/TwoFactorAuthenticationForm.vue": () => import("./assets/TwoFactorAuthenticationForm.0014b3f3.mjs"), "./Pages/Profile/Partials/UpdatePasswordForm.vue": () => import("./assets/UpdatePasswordForm.42f50ab5.mjs"), "./Pages/Profile/Partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm.b818e7a8.mjs"), "./Pages/Profile/Show.vue": () => import("./assets/Show.75ee07c3.mjs"), "./Pages/TermsOfService.vue": () => import("./assets/TermsOfService.a9ae21cd.mjs"), "./Pages/View-Quotation.vue": () => import("./assets/View-Quotation.330e27cf.mjs"), "./Pages/ViewOrder.vue": () => import("./assets/ViewOrder.93646e1a.mjs"), "./Pages/Welcome.vue": () => import("./assets/Welcome.8d4156af.mjs") })),
  setup({ el, app: app2, props, plugin: plugin$1 }) {
    return createApp({ render: () => h$1(app2, props) }).use(plugin$1).use(plugin, defaultConfig({
      config: {
    ...
    })).use(store).use(I, Ziggy).use(VueCameraLib).use(VueInstantSearch).mount(el);
  }
});
