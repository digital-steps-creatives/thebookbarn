...
createInertiaApp({
  ...
  resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./Pages/API/Index.vue": () => import("./assets/Index.f7402072.mjs"), "./Pages/API/Partials/ApiTokenManager.vue": () => import("./assets/ApiTokenManager.9bf937f9.mjs"), "./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword.7020c88f.mjs"), "./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword.58b492d0.mjs"), "./Pages/Auth/Login.vue": () => import("./assets/Login.cbb3c945.mjs"), "./Pages/Auth/Register.vue": () => import("./assets/Register.3fb1dc31.mjs"), "./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword.cc7c877b.mjs"), "./Pages/Auth/TwoFactorChallenge.vue": () => import("./assets/TwoFactorChallenge.fad3138f.mjs"), "./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail.bc51e342.mjs"), "./Pages/Business/Auth/Login.vue": () => import("./assets/Login.4747553c.mjs"), "./Pages/Business/Auth/Register.vue": () => import("./assets/Register.6e0b19f3.mjs"), "./Pages/Business/Dashboard.vue": () => import("./assets/Dashboard.3324058c.mjs"), "./Pages/Business/Generate-Quotation.vue": () => import("./assets/Generate-Quotation.fc7f8808.mjs"), "./Pages/Business/Orders.vue": () => import("./assets/Orders.9da386c8.mjs"), "./Pages/Cart.vue": () => import("./assets/Cart.383596e6.mjs"), "./Pages/Checkout.vue": () => import("./assets/Checkout.4922e5d0.mjs"), "./Pages/Dashboard.vue": () => import("./assets/Dashboard.8238d7e4.mjs"), "./Pages/Home.vue": () => import("./assets/Home.cdc5dfe0.mjs"), "./Pages/Orders.vue": () => import("./assets/Orders.eb81929a.mjs"), "./Pages/PrivacyPolicy.vue": () => import("./assets/PrivacyPolicy.65185f9e.mjs"), "./Pages/Profile/Partials/DeleteUserForm.vue": () => import("./assets/DeleteUserForm.0edf95dd.mjs"), "./Pages/Profile/Partials/LogoutOtherBrowserSessionsForm.vue": () => import("./assets/LogoutOtherBrowserSessionsForm.17af4c27.mjs"), "./Pages/Profile/Partials/TwoFactorAuthenticationForm.vue": () => import("./assets/TwoFactorAuthenticationForm.ef986fa7.mjs"), "./Pages/Profile/Partials/UpdatePasswordForm.vue": () => import("./assets/UpdatePasswordForm.42f50ab5.mjs"), "./Pages/Profile/Partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm.b818e7a8.mjs"), "./Pages/Profile/Show.vue": () => import("./assets/Show.b012c1e0.mjs"), "./Pages/TermsOfService.vue": () => import("./assets/TermsOfService.a9ae21cd.mjs"), "./Pages/View-Quotation.vue": () => import("./assets/View-Quotation.2f688aff.mjs"), "./Pages/Welcome.vue": () => import("./assets/Welcome.8d4156af.mjs") })),
  setup({ el, app: app2, props, plugin }) {
    return createApp({ render: () => h$1(app2, props) }).use(plugin).use(store).use(VueSweetalert2, options).use(I, Ziggy).mount(el);
  }
});
