...
import { _ as _sfc_main$3 } from "./FrontLayout.60695bc7.mjs";
...
import { F as FormButton } from "./CartDropdown.79450e68.mjs";
...
const Cart_vue_vue_type_style_index_0_scoped_2ab855e4_lang = "";
const _sfc_main = {
  computed: {
    ...mapGetters({
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_FrontLayout, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="container mx-auto my-5" data-v-2ab855e4${_scopeId}><div class="lg:flex" data-v-2ab855e4${_scopeId}><div class="lg:w-9/12 lg:mr-5" data-v-2ab855e4${_scopeId}><h5 class="font-semibold text-xl mb-3" data-v-2ab855e4${_scopeId}>Booklist Items</h5>`);
        if (_ctx.cartItems.length) {
          _push2(`<div class="rounded-primary overflow-hidden" data-v-2ab855e4${_scopeId}><div class="overflow-x-auto overflow-y-hidden w-full" data-v-2ab855e4${_scopeId}><table class="filament-tables-table w-full text-left rtl:text-right divide-y table-auto" data-v-2ab855e4${_scopeId}><thead data-v-2ab855e4${_scopeId}><tr class="bg-primary-600" data-v-2ab855e4${_scopeId}><th class="text-white" data-v-2ab855e4${_scopeId}>Book</th><th class="text-white" data-v-2ab855e4${_scopeId}>Name</th><th class="text-white" data-v-2ab855e4${_scopeId}>Price</th><th class="text-white" data-v-2ab855e4${_scopeId}>Quantity</th><th class="text-white" data-v-2ab855e4${_scopeId}></th></tr></thead><tbody class="bg-white divide-y divide-gray-200 pb-3" data-v-2ab855e4${_scopeId}><!--[-->`);
          ssrRenderList(_ctx.cartItems, (item, index) => {
            _push2(`<tr data-v-2ab855e4${_scopeId}><td class="px-3" data-v-2ab855e4${_scopeId}><div class="h-16 w-16" data-v-2ab855e4${_scopeId}><img${ssrRenderAttr("src", item.featured_image)} class="w-full h-full object-cover py-2"${ssrRenderAttr("alt", item.name)} data-v-2ab855e4${_scopeId}></div></td><td class="px-3 text-sm" data-v-2ab855e4${_scopeId}>${ssrInterpolate(item.name)}</td><td class="px-3" data-v-2ab855e4${_scopeId}><span class="text-orange-700 inline-flex text-center rounded-full text-sm" data-v-2ab855e4${_scopeId}>pending quotation</span></td><td class="px-3" data-v-2ab855e4${_scopeId}><input${ssrRenderAttr("value", item.quantity)} type="number" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3 py-2" data-v-2ab855e4${_scopeId}></td><td class="px-3" data-v-2ab855e4${_scopeId}>`);
            _push2(ssrRenderComponent(_component_remove_icon_button, {
              onClick: ($event) => $options.removeFromCart(item)
            }, null, _parent2, _scopeId));
            _push2(`</td></tr>`);
          });
          _push2(`<!--]--></tbody><tfoot data-v-2ab855e4${_scopeId}></tfoot></table></div></div>`);
        } else {
          _push2(`<div data-v-2ab855e4${_scopeId}><div class="flex flex-col items-center justify-center text-gray-300 h-44 bg-gray-50 rounded-lg" data-v-2ab855e4${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" viewBox="0 0 20 20" fill="currentColor" data-v-2ab855e4${_scopeId}><path d="M4 3a2 2 0 100 4h12a2 2 0 100-4H4z" data-v-2ab855e4${_scopeId}></path><path fill-rule="evenodd" d="M3 8h14v7a2 2 0 01-2 2H5a2 2 0 01-2-2V8zm5 3a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1z" clip-rule="evenodd" data-v-2ab855e4${_scopeId}></path></svg><p class="mt-2 text-gray-400" data-v-2ab855e4${_scopeId}>Your Book List is Empty!</p></div></div>`);
        }
        _push2(`</div>`);
        if (_ctx.cartItems.length) {
          _push2(`<div class="md:w-6/12 lg:w-3/12 mt-10 lg:mt-0" data-v-2ab855e4${_scopeId}><h5 class="font-semibold text-xl mb-3" data-v-2ab855e4${_scopeId}>Cart Details</h5><div class="bg-gray-200 p-4 rounded-primary" data-v-2ab855e4${_scopeId}><p class="flex justify-between py-2 text-sm" data-v-2ab855e4${_scopeId}><span class="font-medium" data-v-2ab855e4${_scopeId}> Sub Total: </span><span class="font-bold" data-v-2ab855e4${_scopeId}> request quotation first </span></p><p class="flex justify-between py-2 text-sm border-b border-gray-300" data-v-2ab855e4${_scopeId}><span class="font-medium" data-v-2ab855e4${_scopeId}> Discount: </span><span class="font-bold" data-v-2ab855e4${_scopeId}> request quotation first </span></p><p class="flex justify-between py-2 text-sm" data-v-2ab855e4${_scopeId}><span class="font-medium" data-v-2ab855e4${_scopeId}> Cart Total: </span><span class="font-bold" data-v-2ab855e4${_scopeId}> request quotation first </span></p></div>`);
          if (_ctx.$page.props.user) {
            _push2(`<button class="w-full mt-8 text-sm bg-primary text-white px-6 py-3 block rounded-md text-center" data-v-2ab855e4${_scopeId}>`);
            if ($data.loading) {
              _push2(`<div class="spinner-border" role="status" data-v-2ab855e4${_scopeId}><span class="visually-hidden" data-v-2ab855e4${_scopeId}>Please wait, Loading...</span></div>`);
            } else {
              _push2(`<span data-v-2ab855e4${_scopeId}>Get a Quotation now</span>`);
            }
            _push2(`</button>`);
          } else {
            _push2(`<div data-v-2ab855e4${_scopeId}>`);
            if (_ctx.cartItems.length) {
            ...
            _push2(`<span class="my-5 block text-center font-medium text-lg" data-v-2ab855e4${_scopeId}>or</span>`);
            if (_ctx.cartItems.length) {
              _push2(ssrRenderComponent(_component_Link, {
...
const Cart = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-2ab855e4"]]);
export {
  Cart as default
};
