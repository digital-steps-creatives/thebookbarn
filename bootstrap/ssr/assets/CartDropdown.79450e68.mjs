  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<footer${ssrRenderAttrs(mergeProps({
        ...
        class: "pt-5"
      }, _attrs))}><div class="max-w-7xl mx-auto divide-y divide-slate-200 px-4 sm:px-6 md:px-8 dark:divide-slate-700"><div class="container"><div class="row justify-content-center py-3"><div class="col-4"><span>The Bookbarn | \xA9 2022 All Rights Reserved</span></div></div></div></div></footer>`);
    };
  }
};
