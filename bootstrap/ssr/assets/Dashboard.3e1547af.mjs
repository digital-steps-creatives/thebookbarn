    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ title: "Dashboard" }, _attrs), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="py-12"${_scopeId}><div class="max-w-7xl mx-auto sm:px-6 lg:px-4 px-4"${_scopeId}><div class="mb-5"${_scopeId}><div class="font-bold text-xl text-gray-800 leading-none mb-4"${_scopeId}>${ssrInterpolate(__props.greetings)}, ${ssrInterpolate(_ctx.$page.props.user.name)}</div><h2 class="font-normal text-2xl text-primary"${_scopeId}>Affiliate Program</h2><p${_scopeId}>Share your referral code to potential customers and earn a commission.</p></div><div class="overflow-hidden shadow-sm sm:rounded-lg mb-4"${_scopeId}><div class="bg-green-600 sm:px-5 py-2 sm:flex block justify-between px-4"${_scopeId}><div${_scopeId}><h4 class="text-white"${_scopeId}>Affiliate Stats</h4></div><div${_scopeId}><span class="text-white"${_scopeId}>(Updates after every 30 minutes)</span></div></div><div class="sm:px-5 px-3 py-4 pb-5 bg-white"${_scopeId}><div class="grid grid-cols-2 sm:grid-cols-4 gap-4"${_scopeId}><div class="p-4 bg-green-100 rounded-xl text-gray-800"${_scopeId}><div class="font-bold text-2xl leading-none"${_scopeId}>0</div><div class="mt-2"${_scopeId}>Referrals</div></div><div class="p-4 bg-green-100 rounded-xl text-gray-800"${_scopeId}><div class="font-bold text-2xl leading-none"${_scopeId}>${ssrInterpolate(__props.refcodes.data.length)}</div><div class="mt-2"${_scopeId}>Ref Codes Generate</div></div><div class="p-4 bg-green-100 rounded-xl text-gray-800"${_scopeId}><div class="font-bold text-2xl leading-none"${_scopeId}>0</div><div class="mt-2"${_scopeId}>Total Earnings</div></div><div class="p-4 bg-green-100 rounded-xl text-gray-800"${_scopeId}><div class="font-bold text-2xl leading-none"${_scopeId}>0</div><div class="mt-2"${_scopeId}>Paid Commissions</div></div></div></div></div><div class="overflow-hidden shadow-sm sm:rounded-lg"${_scopeId}><div class="bg-green-600 sm:px-5 py-2 sm:flex block justify-between px-4"${_scopeId}><h4 class="text-white mb-2"${_scopeId}>Referral Codes</h4><button type="submit" class="btn btn-primary block text-white"${_scopeId}>`);
            if (unref(spinner)) {
            ...
            _push2(`</button></div><div class="sm:px-5 px-0 py-4 pb-5 bg-white"${_scopeId}><div class="row"${_scopeId}><div class="col-sm-12" id="unstyle"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Table), {
              ...
              "cell(status)": withCtx(({ item: code }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div${_scopeId2}>`);
                  if (code.status === "not used") {
                    _push3(`<span class="bg-sky-400 inline-flex text-center px-3 py-1.5 rounded-full text-white text-xs"${_scopeId2}>${ssrInterpolate(code.status)}</span>`);
                  } else if (code.status === "used") {
                    _push3(`<span class="bg-teal-400 px-3 py-1.5 inline-flex text-center rounded-full text-white text-xs"${_scopeId2}>${ssrInterpolate(code.status)}</span>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div>`);
                  ...
                  return [
                    createVNode("div", null, [
                      code.status === "not used" ? (openBlock(), createBlock("span", {
                        key: 0,
                        class: "bg-sky-400 inline-flex text-center px-3 py-1.5 rounded-full text-white text-xs"
                      }, toDisplayString(code.status), 1)) : code.status === "used" ? (openBlock(), createBlock("span", {
                        key: 1,
                        class: "bg-teal-400 px-3 py-1.5 inline-flex text-center rounded-full text-white text-xs"
                      }, toDisplayString(code.status), 1)) : createCommentVNode("", true)
                    ])
                  ];
                }
              }),
            ...
            return [
              createVNode("div", { class: "py-12" }, [
                createVNode("div", { class: "max-w-7xl mx-auto sm:px-6 lg:px-4 px-4" }, [
                  ...
                  createVNode("div", { class: "overflow-hidden shadow-sm sm:rounded-lg mb-4" }, [
                    createVNode("div", { class: "bg-green-600 sm:px-5 py-2 sm:flex block justify-between px-4" }, [
                      createVNode("div", null, [
                    ...
                    createVNode("div", { class: "sm:px-5 px-3 py-4 pb-5 bg-white" }, [
                  ...
                  createVNode("div", { class: "overflow-hidden shadow-sm sm:rounded-lg" }, [
                    createVNode("div", { class: "bg-green-600 sm:px-5 py-2 sm:flex block justify-between px-4" }, [
                      createVNode("h4", { class: "text-white mb-2" }, "Referral Codes"),
                      createVNode("button", {
                        type: "submit",
                    ...
                    createVNode("div", { class: "sm:px-5 px-0 py-4 pb-5 bg-white" }, [
