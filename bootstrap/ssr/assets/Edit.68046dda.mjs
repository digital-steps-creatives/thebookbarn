import { resolveComponent, mergeProps, withCtx, unref, createTextVNode, createVNode, toDisplayString, withModifiers, withDirectives, vModelRadio, openBlock, createBlock, Fragment, renderList, vModelSelect, createCommentVNode, vModelCheckbox, vShow, useSSRContext } from "vue";
import { ssrRenderComponent, ssrInterpolate, ssrIncludeBooleanAttr, ssrLooseEqual, ssrRenderList, ssrRenderAttr, ssrLooseContain, ssrRenderStyle } from "vue/server-renderer";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const form = useForm({
      ...
      subject_id: props.product.subject_id,
      class_level_id: props.product.class_level_id,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AppLayout, mergeProps({
        title: "Manage / Products/ " + __props.product.name
      }, _attrs), {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="font-semibold text-xl text-gray-800 leading-tight"${_scopeId}> Manage / Products / ${ssrInterpolate(__props.product.name)} <br${_scopeId}>`);
            ...
            return [
              createVNode("h2", { class: "font-semibold text-xl text-gray-800 leading-tight" }, [
                createTextVNode(" Manage / Products / " + toDisplayString(__props.product.name) + " ", 1),
                createVNode("br"),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (unref(form).product_type === "uniform" || unref(form).product_type === "book") {
              _push2(`<div class="mb-3"${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$2, {
                for: "class_level",
              ...
              _push2(ssrRenderComponent(_sfc_main$1, {
                class: "mt-2",
                message: unref(form).errors.class_level_id
              }, null, _parent2, _scopeId));
              _push2(`</div>`);
            } else {
              _push2(`<!---->`);
                    ...
                    createVNode("div", { class: "row justify-content-center" }, [
                      createVNode("div", { class: "col-sm-6" }, [
                        ...
                        createVNode("form", {
                          ...
                          onSubmit: withModifiers(updateProduct, ["prevent"])
                        }, [
                          ...
                          unref(form).product_type === "uniform" || unref(form).product_type === "book" ? (openBlock(), createBlock("div", {
                            key: 1,
                            class: "mb-3"
                          }, [
                            createVNode(_sfc_main$2, {
