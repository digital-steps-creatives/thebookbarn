...
import { _ as _sfc_main$2, A as ApplicationMark, b as _sfc_main$3, c as _sfc_main$4, d as _sfc_main$5 } from "./ResponsiveNavLink.016ef96f.mjs";
import { C as CartDropdown, _ as _sfc_main$6 } from "./CartDropdown.b11f13c5.mjs";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div class="col-sm-5 hidden sm:block"><div class="relative mt-4 hidden sm:block">`);
      _push(ssrRenderComponent(Search, null, null, _parent));
      _push(`</div></div><div class="col-sm-4 col-4"><div class="flex justify-between"><div class="sm:mt-4 mt-4 relative"><div class="flex justify-between">`);
      _push(ssrRenderComponent(CartDropdown, { class: "sm:py-3 sm:pt-0" }, null, _parent));
      _push(`<div class="sm:py-3 sm:pt-0 hidden sm:block"><div class="flex">`);
      ...
      _push(`<span class="px-2 pt-2.5">|</span>`);
      if (!_ctx.$page.props.user) {
        _push(ssrRenderComponent(unref(Link), {
          class: "mr-2 flex text-decoration-none sm:my-3",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="text-green-500 hover:text-red-500"${_scopeId}>Affiliates Log In</span>`);
            } else {
              return [
                createVNode("span", { class: "text-green-500 hover:text-red-500" }, "Affiliates Log In")
              ];
            }
          }),
          _: 1
              ...
              return [
                createVNode("span", { class: "inline-flex rounded-md" }, [
                  createVNode("button", {
                    ...
                    createTextVNode(toDisplayString(__props.greetings) + " " + toDisplayString(_ctx.$page.props.user.current_team.name) + " ", 1),
      ...
      if (!_ctx.$page.props.user) {
        _push(ssrRenderComponent(_sfc_main$5, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` Customer Login `);
            } else {
              return [
                createTextVNode(" Customer Login ")
              ];
            }
          }),
          _: 1
      ...
      if (!_ctx.$page.props.user) {
        _push(ssrRenderComponent(_sfc_main$5, {
          href: _ctx.route("affiliates.landing"),
          active: _ctx.route().current("affiliates.landing")
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` Affiliate Login `);
            } else {
              return [
                createTextVNode(" Affiliate Login ")
              ];
            }
          }),
          _: 1
