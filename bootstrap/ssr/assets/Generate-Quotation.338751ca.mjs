...
import { A as AppLayout } from "./VendorsLayout.9a454ca6.mjs";
                ...
                createVNode("div", null, [
                  createVNode("div", { class: "bg-white overflow-hidden shadow-xl sm:rounded-lg" }, [
                    createVNode("div", { id: "invoice-app" }, [
                      ...
                      createVNode("table", { class: "responsive-table table" }, [
                        createVNode("thead", null, [
                          createVNode("tr", null, [
                            createVNode("th", null, "No"),
                            createVNode("th", { style: { "width": "40%" } }, "Book/Item"),
                            createVNode("th", { style: { "width": "20%" } }, "Price/unite"),
                            createVNode("th", { style: { "width": "15%" } }, "Quantity"),
                            createVNode("th", { style: { "width": "10%" } }, "Total"),
                            createVNode("th", { style: { "width": "10%" } })
                          ])
                        ]),
