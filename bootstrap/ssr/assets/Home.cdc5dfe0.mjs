import { ref, useSSRContext, resolveComponent, mergeProps, withCtx, createVNode, unref, createTextVNode, openBlock, createBlock, Fragment, renderList, toDisplayString } from "vue";
import { ssrRenderAttrs, ssrRenderClass, ssrRenderStyle, ssrRenderAttr, ssrRenderComponent, ssrInterpolate, ssrRenderSlot, ssrRenderList } from "vue/server-renderer";
import { _ as _sfc_main$6 } from "./FrontLayout.7e21ee94.mjs";
import "./Welcome.e5bbd56d.mjs";
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if ($data.isCameraOpen) {
    _push(`<div style="${ssrRenderStyle(!$data.isLoading ? null : { display: "none" })}" class="${ssrRenderClass([{ "flash": $data.isShotPhoto }, "camera-box"])}"><div class="${ssrRenderClass([{ "flash": $data.isShotPhoto }, "camera-shutter"])}"></div><video style="${ssrRenderStyle(!$data.isPhotoTaken ? null : { display: "none" })}"${ssrRenderAttr("width", 350)}${ssrRenderAttr("height", 337.5)} autoplay></video><canvas style="${ssrRenderStyle($data.isPhotoTaken ? null : { display: "none" })}" id="photoTaken"${ssrRenderAttr("width", 350)}${ssrRenderAttr("height", 337.5)}></canvas></div>`);
  } else {
    _push(`<!---->`);
  }
...
const Hero = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$2]]);
...
const ProductCard = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-a1b32288"]]);
const _sfc_main$3 = {};
          ...
          if (_push2) {
            ...
            ssrRenderList(__props.listavailablebooks, (bookItem) => {
              ...
              if (((_a = bookItem == null ? void 0 : bookItem.classlevel) == null ? void 0 : _a.level) === "primary") {
                ...
                _push2(`<span class="bg-cyan-600 p-2 rounded-full text-xs text-white"${_scopeId}>${ssrInterpolate((_c = bookItem == null ? void 0 : bookItem.classlevel) == null ? void 0 : _c.level)}</span>`);
              }
              _push2(` | Class: ${ssrInterpolate((_d = bookItem == null ? void 0 : bookItem.classlevel) == null ? void 0 : _d.class)}</h5><h6 class="font-normal text-sm text-gray-400 mb-3"${_scopeId}>Subject: ${ssrInterpolate((_e = bookItem == null ? void 0 : bookItem.subject) == null ? void 0 : _e.name)}</h6><button class="text-white bg-emerald-400 hover:bg-emerald-500 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-normal rounded-lg text-sm px-4 py-2 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-2 -ml-1 w-5 h-5"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15"${_scopeId}></path></svg> Add to your List </button></figcaption></figure></div></div>`);
            });
            _push2(`<!--]--></div></div></section><section class="py-14 bg-green-900"${_scopeId}><div class="container"${_scopeId}><div class="row justify-content-center mb-5"${_scopeId}><div class="col-8 text-center"${_scopeId}><span class="fs-5 text-warning ls-md text-uppercase fw-semi-bold"${_scopeId}>new way of doing business </span><h2 class="display-3 mt-4 mb-3 text-white fw-bold"${_scopeId}>Are you a Bookshop or Book Vendor?</h2><p class="lead text-white-50 px-lg-8 mb-6"${_scopeId}>Interested in Ready Business?</p>`);
            ...
            _push2(`</div></div></div></section><section class="bg-gray-100 py-16"${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8"${_scopeId}><div class="container"${_scopeId}><div class="row"${_scopeId}><div class="col-sm-4"${_scopeId}><span class="icon inline-flex align-top"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-12 h-12 text-green-800"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"${_scopeId}></path></svg></span><span class="text-green-800 font-medium text-2xl inline-flex leading-10 mt-1"${_scopeId}>Value for your money</span></div><div class="col-sm-4"${_scopeId}><span class="icon inline-flex align-top"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-12 h-12 text-green-800"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M16.712 4.33a9.027 9.027 0 011.652 1.306c.51.51.944 1.064 1.306 1.652M16.712 4.33l-3.448 4.138m3.448-4.138a9.014 9.014 0 00-9.424 0M19.67 7.288l-4.138 3.448m4.138-3.448a9.014 9.014 0 010 9.424m-4.138-5.976a3.736 3.736 0 00-.88-1.388 3.737 3.737 0 00-1.388-.88m2.268 2.268a3.765 3.765 0 010 2.528m-2.268-4.796a3.765 3.765 0 00-2.528 0m4.796 4.796c-.181.506-.475.982-.88 1.388a3.736 3.736 0 01-1.388.88m2.268-2.268l4.138 3.448m0 0a9.027 9.027 0 01-1.306 1.652c-.51.51-1.064.944-1.652 1.306m0 0l-3.448-4.138m3.448 4.138a9.014 9.014 0 01-9.424 0m5.976-4.138a3.765 3.765 0 01-2.528 0m0 0a3.736 3.736 0 01-1.388-.88 3.737 3.737 0 01-.88-1.388m2.268 2.268L7.288 19.67m0 0a9.024 9.024 0 01-1.652-1.306 9.027 9.027 0 01-1.306-1.652m0 0l4.138-3.448M4.33 16.712a9.014 9.014 0 010-9.424m4.138 5.976a3.765 3.765 0 010-2.528m0 0c.181-.506.475-.982.88-1.388a3.736 3.736 0 011.388-.88m-2.268 2.268L4.33 7.288m6.406 1.18L7.288 4.33m0 0a9.024 9.024 0 00-1.652 1.306A9.025 9.025 0 004.33 7.288"${_scopeId}></path></svg></span><span class="text-green-800 font-medium text-2xl inline-flex leading-10 mt-1"${_scopeId}>24/7 Support</span></div><div class="col-sm-4"${_scopeId}><span class="icon inline-flex align-top"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-12 h-12 text-green-800"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z"${_scopeId}></path></svg></span><span class="text-green-800 font-medium text-2xl inline-flex leading-10 mt-1"${_scopeId}>Safe and secure online payment</span></div></div></div></div></section>`);
          } else {
            return [
              createVNode(Hero),
              createVNode("section", {
                          ...
                          createVNode("figure", null, [
                            ...
                            createVNode("figcaption", { class: "mb-4" }, [
                              ...
                              createVNode("h5", { class: "my-2 text-sm" }, [
                                ...
                                }, toDisplayString((_b = bookItem == null ? void 0 : bookItem.classlevel) == null ? void 0 : _b.level), 1)) : (openBlock(), createBlock("span", {
                                  key: 1,
                                  class: "bg-cyan-600 p-2 rounded-full text-xs text-white"
                                }, toDisplayString((_c = bookItem == null ? void 0 : bookItem.classlevel) == null ? void 0 : _c.level), 1)),
                                createTextVNode(" | Class: " + toDisplayString((_d = bookItem == null ? void 0 : bookItem.classlevel) == null ? void 0 : _d.class), 1)
                              ]),
                              createVNode("h6", { class: "font-normal text-sm text-gray-400 mb-3" }, "Subject: " + toDisplayString((_e = bookItem == null ? void 0 : bookItem.subject) == null ? void 0 : _e.name), 1),
                              createVNode("button", {
                ...
                createVNode("div", { class: "container" }, [
                  createVNode("div", { class: "row justify-content-center mb-5" }, [
                    createVNode("div", { class: "col-8 text-center" }, [
                      ...
                      createVNode("h2", { class: "display-3 mt-4 mb-3 text-white fw-bold" }, "Are you a Bookshop or Book Vendor?"),
              ...
              createVNode("section", { class: "bg-gray-100 py-16" }, [
                  ...
                  createVNode("div", { class: "container" }, [
                    createVNode("div", { class: "row" }, [
                      createVNode("div", { class: "col-sm-4" }, [
                        ...
                        createVNode("span", { class: "text-green-800 font-medium text-2xl inline-flex leading-10 mt-1" }, "Value for your money")
                      ]),
                      createVNode("div", { class: "col-sm-4" }, [
                        createVNode("span", { class: "icon inline-flex align-top" }, [
                          (openBlock(), createBlock("svg", {
                        ...
                        createVNode("span", { class: "text-green-800 font-medium text-2xl inline-flex leading-10 mt-1" }, "24/7 Support")
                      ]),
                      createVNode("div", { class: "col-sm-4" }, [
                        createVNode("span", { class: "icon inline-flex align-top" }, [
                          (openBlock(), createBlock("svg", {
                        ...
                        createVNode("span", { class: "text-green-800 font-medium text-2xl inline-flex leading-10 mt-1" }, "Safe and secure online payment")
                      ])
                    ])
                  ])
                ])
