...
import "js-cookie";
const Login_vue_vue_type_style_index_0_scoped_b03adc91_lang = "";
const _sfc_main = {
  __name: "Login",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="container my-12 py-8" data-v-b03adc91${_scopeId}><div class="row g-5 align-center" data-v-b03adc91${_scopeId}><div class="col-sm-5" data-v-b03adc91${_scopeId}><form class="p-5 bg-white/50 space-y-8 backdrop-blur-xl border border-gray-200 shadow rounded" data-v-b03adc91${_scopeId}><div class="w-full" data-v-b03adc91${_scopeId}><div class="filament-brand text-xl font-bold tracking-tight" data-v-b03adc91${_scopeId}> Affiliates Login </div></div>`);
            if (__props.status) {
              _push2(`<div class="my-4 font-medium text-sm text-green-600" data-v-b03adc91${_scopeId}>${ssrInterpolate(__props.status)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div data-v-b03adc91${_scopeId}>`);
            ...
            _push2(`</div><div class="mt-4" data-v-b03adc91${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              for: "password",
              value: "Password"
            }, null, _parent2, _scopeId));
            ...
            _push2(`</div><div class="flex items-center justify-between mt-4" data-v-b03adc91${_scopeId}><label class="" data-v-b03adc91${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$5, {
              checked: unref(form).remember_token,
              "onUpdate:checked": ($event) => unref(form).remember_token = $event,
              name: "remember"
            }, null, _parent2, _scopeId));
            _push2(`<span class="ml-2 text-sm text-gray-600" data-v-b03adc91${_scopeId}>Remember me</span></label></div><div class="flex items-center mt-4" data-v-b03adc91${_scopeId}>`);
            ...
            _push2(`</div><div class="flex items-center mt-4" data-v-b03adc91${_scopeId}>`);
            ...
            _push2(`</div></form></div><div class="col-sm-7" data-v-b03adc91${_scopeId}><img src="/images/illustration.svg" alt="" class="flex mx-auto" data-v-b03adc91${_scopeId}></div></div></div><section class="bg-green-100 py-5" data-v-b03adc91${_scopeId}><div class="container" data-v-b03adc91${_scopeId}><div class="row" data-v-b03adc91${_scopeId}><h2 class="text-center mb-4 text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-green-600 font-bold leading-tight" data-v-b03adc91${_scopeId}>FAQs</h2><div class="col-12" data-v-b03adc91${_scopeId}><div class="row mb-4" data-v-b03adc91${_scopeId}><div class="col-sm-4" data-v-b03adc91${_scopeId}><h4 data-v-b03adc91${_scopeId}>What&#39;s the affiliate program?</h4></div><div class="col-sm-8" data-v-b03adc91${_scopeId}><p data-v-b03adc91${_scopeId}>We offer commission for each qualified referral who signs up and makes a purchase of any of our products through their affiliate link.</p></div></div><div class="row mb-4" data-v-b03adc91${_scopeId}><div class="col-sm-4" data-v-b03adc91${_scopeId}><h4 data-v-b03adc91${_scopeId}>How much will I get paid?</h4></div><div class="col-sm-8" data-v-b03adc91${_scopeId}><p data-v-b03adc91${_scopeId}>It&#39;s a 10% commission on the administration cost for every order purchase and paid for using your unique link/code. For qualifications, check out our terms of service.</p></div></div><div class="row" data-v-b03adc91${_scopeId}><div class="col-sm-4" data-v-b03adc91${_scopeId}><h4 data-v-b03adc91${_scopeId}>How will I get paid?</h4></div><div class="col-sm-8" data-v-b03adc91${_scopeId}><p data-v-b03adc91${_scopeId}>We pay commissions through Mpesa instant when we receive a payment from your referral.</p></div></div></div></div></div></section><section class="bg-gray-50 py-9" data-v-b03adc91${_scopeId}><div class="container" data-v-b03adc91${_scopeId}><div class="row justify-content-center" data-v-b03adc91${_scopeId}><div class="col-6" data-v-b03adc91${_scopeId}><p data-v-b03adc91${_scopeId}>BECOME AN AFFILIATE</p><h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-green-500 font-bold leading-tight" data-v-b03adc91${_scopeId}>Sign up fast, for free.</h2><p data-v-b03adc91${_scopeId}>In just a few minutes, you&#39;ll have a unique tracking code.</p><p data-v-b03adc91${_scopeId}>Send your unique code to your referrals, once they purchase any item, you earn</p>`);
            _push2(ssrRenderComponent(unref(Link), {
...
const Login = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b03adc91"]]);
export {
  Login as default
};
