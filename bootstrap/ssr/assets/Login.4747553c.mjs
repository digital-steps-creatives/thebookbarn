...
import "vuex";
const Login_vue_vue_type_style_index_0_scoped_35bf787d_lang = "";
const _sfc_main = {
  __name: "Login",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="container my-5" data-v-35bf787d${_scopeId}><div class="row" data-v-35bf787d${_scopeId}><div class="col-sm-5" data-v-35bf787d${_scopeId}><div class="bg-white p-5 shadow rounded" data-v-35bf787d${_scopeId}><h4 class="text-red-600" data-v-35bf787d${_scopeId}>Welcome back! Login to continue!</h4><hr data-v-35bf787d${_scopeId}>`);
            if (__props.status) {
              _push2(`<div class="mb-4 font-medium text-sm text-green-600" data-v-35bf787d${_scopeId}>${ssrInterpolate(__props.status)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<form data-v-35bf787d${_scopeId}><div data-v-35bf787d${_scopeId}>`);
            ...
            _push2(`</div><div class="mt-4" data-v-35bf787d${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              for: "password",
              value: "Password"
            }, null, _parent2, _scopeId));
            ...
            _push2(`</div><div class="flex items-center justify-between mt-4" data-v-35bf787d${_scopeId}><label class="" data-v-35bf787d${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$5, {
              checked: unref(form).remember_token,
              "onUpdate:checked": ($event) => unref(form).remember_token = $event,
              name: "remember"
            }, null, _parent2, _scopeId));
            _push2(`<span class="ml-2 text-sm text-gray-600" data-v-35bf787d${_scopeId}>Remember me</span></label>`);
            ...
            _push2(`</div><div class="flex items-center justify-end mt-4" data-v-35bf787d${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
            ...
            _push2(`</div><div class="flex justify-content-center" data-v-35bf787d${_scopeId}>`);
            ...
            _push2(`</div></form></div></div><div class="col-sm-7" data-v-35bf787d${_scopeId}><img src="/images/illustration.svg" alt="" class="flex mx-auto" data-v-35bf787d${_scopeId}></div></div></div>`);
          } else {
            return [
                ...
                createVNode("div", { class: "row" }, [
                  createVNode("div", { class: "col-sm-5" }, [
                    createVNode("div", { class: "bg-white p-5 shadow rounded" }, [
                      createVNode("h4", { class: "text-red-600" }, "Welcome back! Login to continue!"),
                      createVNode("hr"),
...
const Login = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-35bf787d"]]);
export {
  Login as default
};
