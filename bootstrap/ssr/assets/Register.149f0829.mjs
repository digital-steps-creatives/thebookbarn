    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="container my-5"${_scopeId}><div class="row"${_scopeId}><div class="col-sm-5"${_scopeId}><div class="bg-white p-5 shadow rounded"${_scopeId}><h4 class="text-red-600 mb-3"${_scopeId}>Register an Account</h4><hr${_scopeId}><form${_scopeId}><div${_scopeId}>`);
                ...
                createVNode("div", { class: "row" }, [
                  createVNode("div", { class: "col-sm-5" }, [
                    createVNode("div", { class: "bg-white p-5 shadow rounded" }, [
                      createVNode("h4", { class: "text-red-600 mb-3" }, "Register an Account"),
                      createVNode("hr"),
                      createVNode("form", {
