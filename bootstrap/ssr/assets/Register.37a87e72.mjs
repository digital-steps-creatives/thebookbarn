...
import { _ as _sfc_main$1 } from "./FrontLayout.014431c8.mjs";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="container my-5"${_scopeId}><div class="row"${_scopeId}><div class="col-sm-5"${_scopeId}><div class="bg-white p-5 shadow rounded"${_scopeId}><div class="w-full"${_scopeId}><div class="filament-brand text-xl font-bold tracking-tight"${_scopeId}> Affiliates Registration </div></div><hr${_scopeId}><form${_scopeId}><div${_scopeId}>`);
            ...
            _push2(`</div><div class="mt-4"${_scopeId}><label for="" class="block font-medium text-sm text-gray-700 mb-2"${_scopeId}><span${_scopeId}>Choose type of Account</span></label><ul class="grid gap-6 w-full md:grid-cols-2" style="${ssrRenderStyle({ "padding-left": "0" })}"${_scopeId}><li${_scopeId}><input type="radio" id="role__teacher" name="role" value="teacher"${ssrIncludeBooleanAttr(ssrLooseEqual(unref(form).role, "teacher")) ? " checked" : ""} class="hidden peer" required${_scopeId}><label for="role__teacher" class="inline-flex justify-between items-center border-2 p-3 w-full text-gray-500 rounded-lg border-gray-200 cursor-pointer peer-checked:border-green-600 peer-checked:text-green-600 hover:text-gray-600 hover:bg-gray-200 ring-green-600"${_scopeId}><div class="block"${_scopeId}><div class="w-full text-sm font-semibold"${_scopeId}>Teacher</div></div><svg aria-hidden="true" class="ml-3 w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"${_scopeId}><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"${_scopeId}></path></svg></label></li><li${_scopeId}><input type="radio" id="role__other" name="role" value="other"${ssrIncludeBooleanAttr(ssrLooseEqual(unref(form).role, "other")) ? " checked" : ""} class="hidden peer"${_scopeId}><label for="role__other" class="inline-flex justify-between items-center border-2 p-3 w-full text-gray-500 rounded-lg border-gray-200 cursor-pointer peer-checked:border-green-600 peer-checked:text-green-600 hover:text-gray-600 hover:bg-gray-100"${_scopeId}><div class="block"${_scopeId}><div class="w-full text-sm font-semibold"${_scopeId}>Other</div></div><svg aria-hidden="true" class="ml-3 w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"${_scopeId}><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"${_scopeId}></path></svg></label></li></ul></div><div class="mt-4"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              for: "password",
              value: "Password"
            }, null, _parent2, _scopeId));
            ...
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("affiliates.landing"),
              class: "underline text-sm text-gray-600 hover:text-gray-900"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`</div><section class="bg-green-100 py-5"${_scopeId}><div class="container"${_scopeId}><div class="row"${_scopeId}><h2 class="text-center mb-4 text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-green-600 font-bold leading-tight"${_scopeId}>FAQs</h2><div class="col-12"${_scopeId}><div class="row mb-4"${_scopeId}><div class="col-sm-4"${_scopeId}><h4${_scopeId}>What&#39;s the affiliate program?</h4></div><div class="col-sm-8"${_scopeId}><p${_scopeId}>We offer commission for each qualified referral who signs up and makes a purchase of any of our products through their affiliate link.</p></div></div><div class="row mb-4"${_scopeId}><div class="col-sm-4"${_scopeId}><h4${_scopeId}>How much will I get paid?</h4></div><div class="col-sm-8"${_scopeId}><p${_scopeId}>It&#39;s a 10% commission on the administration cost for every order purchase and paid for using your unique link/code. For qualifications, check out our terms of service.</p></div></div><div class="row"${_scopeId}><div class="col-sm-4"${_scopeId}><h4${_scopeId}>How will I get paid?</h4></div><div class="col-sm-8"${_scopeId}><p${_scopeId}>We pay commissions through Mpesa instant when we receive a payment from your referral.</p></div></div></div></div></div></section>`);
          } else {
            return [
                  ...
                  createVNode("div", { class: "col-sm-5" }, [
                    createVNode("div", { class: "bg-white p-5 shadow rounded" }, [
                      createVNode("div", { class: "w-full" }, [
                        createVNode("div", { class: "filament-brand text-xl font-bold tracking-tight" }, " Affiliates Registration ")
                      ]),
                      createVNode("hr"),
                      createVNode("form", {
                        ...
                        createVNode("div", { class: "mt-4" }, [
                          createVNode("label", {
                            ...
                            createVNode("span", null, "Choose type of Account")
                          ]),
                          createVNode("ul", {
                            ...
                            createVNode("li", null, [
                              ...
                              createVNode("label", {
                                ...
                                createVNode("div", { class: "block" }, [
                                  createVNode("div", { class: "w-full text-sm font-semibold" }, "Teacher")
                                ]),
                            ...
                            createVNode("li", null, [
                              ...
                              createVNode("label", {
                                ...
                                createVNode("div", { class: "block" }, [
                                  createVNode("div", { class: "w-full text-sm font-semibold" }, "Other")
                                ]),
                                (openBlock(), createBlock("svg", {
                                  "aria-hidden": "true",
                                  class: "ml-3 w-6 h-6",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Affiliates/Register.vue");
