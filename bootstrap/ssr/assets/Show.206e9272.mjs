import { mergeProps, withCtx, unref, createTextVNode, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, createCommentVNode, withModifiers, useSSRContext } from "vue";
      ...
      _push(ssrRenderComponent(AppLayout, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</tbody></table></div></div></div></div></div><div class="col-sm-12"${_scopeId}><div class="bg-white p-8 sm:rounded-lg"${_scopeId}><h4${_scopeId}>Basic Information</h4><form id="basic__information"${_scopeId}><div class="mb-3"${_scopeId}>`);
              ...
              createVNode("div", { class: "py-12" }, [
                createVNode("div", { class: "max-w-7xl mx-auto sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "row" }, [
                    createVNode("div", { class: "col-sm-12 mb-3" }, [
                            ...
                            createVNode("div", { class: "overflow-x-auto" }, [
                              createVNode("table", { class: "table-auto w-full" }, [
                                ...
                                createVNode("tbody", { class: "text-sm divide-y divide-gray-100" }, [
                                  __props.customer.orders <= 0 ? (openBlock(), createBlock("tr", { key: 0 }, [
                                    createVNode("td", { colspan: "3" }, "Sorry no Orders found")
                                  ])) : (openBlock(true), createBlock(Fragment, { key: 1 }, renderList(__props.customer.orders, (order, key) => {
