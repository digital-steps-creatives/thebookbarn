import { ref, unref, withCtx, createTextVNode, createVNode, openBlock, createBlock, Fragment, withModifiers, useSSRContext, nextTick } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="container my-5"${_scopeId}><div class="row justify-content-center"${_scopeId}><div class="col-sm-5"${_scopeId}><h4 class="text-primary"${_scopeId}>Two Factor Authentication Confirmation</h4><div class="bg-white p-5 shadow rounded"${_scopeId}><div class="mb-4 text-sm text-gray-600"${_scopeId}>`);
            if (!recovery.value) {
              ...
              createVNode("div", { class: "container my-5" }, [
                createVNode("div", { class: "row justify-content-center" }, [
                  createVNode("div", { class: "col-sm-5" }, [
                    createVNode("h4", { class: "text-primary" }, "Two Factor Authentication Confirmation"),
