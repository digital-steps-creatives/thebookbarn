import { computed, unref, withCtx, createTextVNode, createVNode, openBlock, createBlock, createCommentVNode, withModifiers, useSSRContext } from "vue";
import { ssrRenderComponent } from "vue/server-renderer";
import { useForm, Head, Link } from "@inertiajs/inertia-vue3";
import { _ as _sfc_main$1 } from "./FrontLayout.014431c8.mjs";
import "./AuthenticationCardLogo.679e9e13.mjs";
import { _ as _sfc_main$2 } from "./PrimaryButton.1245566b.mjs";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="container my-5"${_scopeId}><div class="row justify-content-center"${_scopeId}><div class="col-sm-5"${_scopeId}><div class="bg-white p-5 shadow rounded"${_scopeId}><h4 class="text-primary"${_scopeId}>Email Verification</h4><div class="mb-4 text-sm text-gray-600"${_scopeId}> Before continuing, could you verify your email address by clicking on the link we just emailed to you? If you didn&#39;t receive the email, we will gladly send you another. </div>`);
                ...
                createVNode("div", { class: "row justify-content-center" }, [
                  createVNode("div", { class: "col-sm-5" }, [
                    createVNode("div", { class: "bg-white p-5 shadow rounded" }, [
                      createVNode("h4", { class: "text-primary" }, "Email Verification"),
