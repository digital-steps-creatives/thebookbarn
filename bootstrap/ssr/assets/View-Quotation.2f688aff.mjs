import { ref, computed, mergeProps, withCtx, createVNode, toDisplayString, unref, openBlock, createBlock, Fragment, renderList, withDirectives, vModelText, createTextVNode, useSSRContext } from "vue";
import { ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr } from "vue/server-renderer";
import { A as AppLayout } from "./VendorsLayout.c6e9d430.mjs";
                          ...
                          return openBlock(), createBlock("tr", { key: index }, [
                            ...
                            createVNode("td", { "data-label": "Price/unite" }, [
                              createVNode("div", { class: "cell-with-input" }, [
                                createVNode("span", { class: "pt-2" }, toDisplayString(unref(quotation).invoiceCurrency.symbol), 1),
                                createTextVNode(),
                                withDirectives(createVNode("input", {
                                  type: "number",
                                  min: "0",
                          ...
                          createVNode("td", null, [
                            createVNode("div", { class: "cell-with-input" }, [
                              ...
                              withDirectives(createVNode("input", {
                                ...
                                min: "0",
                                max: "100",
                                "onUpdate:modelValue": ($event) => unref(quotation).taxRate = $event
                              }, null, 8, ["onUpdate:modelValue"]), [
                                [vModelText, unref(quotation).taxRate]
                              ]),
                              createTextVNode("%")
                            ])
                          ]),
