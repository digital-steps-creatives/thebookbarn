...
<template>
    <AppLayout :title="'Manage / Products/ ' + product.name">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Manage / Products / {{product.name}} <br><Link :href="route('admin.manage.products')" class="text-secondary-600 text-decoration-none text-sm">Back to Products</Link>
            </h2>
        </template>
                ...
                <div class="bg-white p-8 sm:rounded-lg">
                    <div class="row justify-content-center">
                        <div class="col-sm-6">
                                ...
                                <form id="basic__information" @submit.prevent="updateProduct">
                                    <div>
                                        <FormKit 
                                        type="text" 
                                        label="Full Names" 
                                    ...
                                    <div class="mb-3"  v-if="form.product_type ==='uniform' || form.product_type ==='book'">
                                        ...
                                        <InputError class="mt-2" :message="form.errors.class_level_id" />
                                    </div>
                                    <div>
                                        <FormKit 
                                        type="select" 
